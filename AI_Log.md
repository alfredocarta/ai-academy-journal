...
- ## 2026-04-15 - Giorno 8 e 9
- Task: Esercizio L0 Giorno 8 - Sicurezza e AI Responsabile: analisi dei 5 rischi AI applicati alla pipeline studio + scrittura mini policy di 5 regole. Esercizio L0 Giorno 9 - task mapping settimana tipo nelle 3 categorie AI-automatizzabile, AI-assistito, Solo-umano.
- Risultato: Rischi principali identificati: allucinazioni (trascrizione errata di termini tecnici), privacy (registrazioni vocali su cloud), lock-in (dipendenza da un solo provider), non-determinismo (output diversi a ogni run). Bias marginale per questo caso d'uso. Mini policy scritta con 5 regole operative. Task mapping: 2 AI-automatizzabili (trascrizione lezioni, AI Log), 3 AI-assistiti (riassunto documenti, email, preparazione call), 3 Solo-umano (call, lettura documenti, studio attivo). Risparmio totale stimato: ~6h/settimana.
- Tempo senza AI: n/a | Tempo con AI: ~25 min
- Note: Il rischio piu' concreto per la pipeline studio e' il non-determinismo combinato con la mancanza di versioning. La regola piu' critica: non usare mai le flashcard senza averle lette. Il task con ROI piu' alto rimane la trascrizione audio (36x). EU AI Act Art. 4 confermato come obbligo legale attivo da febbraio 2025.
